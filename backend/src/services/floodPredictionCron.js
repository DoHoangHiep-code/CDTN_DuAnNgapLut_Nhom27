...
const CHUNK_SIZE = 1000        // tăng từ 500 → 1000
const PARALLEL_WORKERS = 4    // số chunk chạy đồng thời
...
async function processChunk(chunk, nodeIds, chunkIndex, totalChunks) {
  ...
  try {
    ...
    console.error(`[PredictionCron] ❌ Chunk ${chunkIndex + 1}/${totalChunks} AI lỗi:`, err.message)
