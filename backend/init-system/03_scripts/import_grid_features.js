 ...
 * ─────────────────────────────────────────────────────────────────────────────
 * Nạp 53.291 điểm lưới từ CSV vào bảng grid_nodes trên CockroachDB.
 * Phiên bản này áp dụng "Throttling Strategy" để tránh Timeout:
 *   • BATCH_SIZE   = 200 rows/lần  (an toàn với CockroachDB connection pooler)
...
async function importGridFeatures() {
  ...
  console.log('──────────────────────────────────────────────────────────────\n')
  console.log('📋  Kiểm tra trên CockroachDB SQL Editor:')
