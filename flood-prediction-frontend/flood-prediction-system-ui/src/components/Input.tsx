...
// forwardRef cho phép component cha truy cập trực tiếp thẻ <input> bên trong
// (ví dụ: focus() sau khi GPS lỗi trong FloodReportModal)
export const Input = React.forwardRef<HTMLInputElement, Props>(
  function Input({ label, hint, error, className, ...props }, ref) {
    return (
